      ...
      layout: (props) => {
        return createElement(Fragment, null, 
          createElement('style', null, `
            /* 1. PERSONALIZACIÓN DEL LOGO LOCAL (GM) */
            [data-testid="brand-logo"] {
              /* Usamos el logo de Chevrolet local */
              background-image: url('/static/Chevrolet-Logo.png') !important;
            ...
            /* 4. CAMBIO DE COLOR "PUBLISHED" (DE VERDE A AZUL CHEVROLET) */
